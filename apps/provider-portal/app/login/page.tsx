      ...
      >
        ...
        <div style={{ padding: '36px 32px 32px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: '28px' }}>
            ...
            >
              Manage your service listings, client inquiries & payout balances.
            </p>
          </div>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  onFocus={(e) => {
                    e.target.style.borderColor = '#2C5F9E';
                    e.target.style.background = '#FFFFFF';
                    e.target.style.boxShadow = '0 0 0 3px rgba(44, 95, 158, 0.15)';
                  }}
                  onBlur={(e) => {
          ...
          <div style={{ textAlign: 'center', marginTop: '22px' }}>
            <span style={{ fontSize: '13px', color: '#5A6A80' }}>
              Want to join the bldr marketplace?{' '}
            </span>
            <Link
              href="/register"
              style={{
